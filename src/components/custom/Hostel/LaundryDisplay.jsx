...
export default function LaundrySchedule({ hostelData }) {
    ...
    return (
       <div>
  <h1 className="text-xl font-bold mb-2 text-center text-gray-900 dark:text-gray-100">
    Laundry Dates
  </h1>
  ...
  {schedule.length > 0 ? (
    <div className="overflow-x-auto">
      <Table className="bg-white dark:bg-slate-800 text-gray-900 dark:text-gray-100">
        <TableHeader>
          <TableRow>
