      ...
      <div className="max-w-7xl mx-auto px-3 py-6 text-center w-full">
        ...
        <div className="flex items-center justify-center gap-6 mb-4">
          <a
            ...
            className="flex items-center justify-center p-2 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition"
          >
