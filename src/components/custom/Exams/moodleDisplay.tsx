        ...
        return (
            <div className="text-xl mb-4 text-center text-gray-900 dark:text-gray-100 midnight:text-gray-100">
                <h1 className="font-bold">
                    Moodle/LMS Data 
                    <button onClick={() => {window.scrollTo({ top: 0, behavior: "smooth" }); handleFetchMoodle()}} className="mt-2 px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-medium transition-colors">
