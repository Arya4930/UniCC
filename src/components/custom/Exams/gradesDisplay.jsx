...
export default function GradesDisplay({ data }) {
  if (!data || !data.cgpa) return <p className="text-gray-700 dark:text-gray-300">No grades data available.</p>;
  ...
  return (
    <div className="grid gap-2">
      ...
      <Card className="bg-white dark:bg-slate-800">
        <CardHeader>
          <CardTitle className="text-lg font-bold text-gray-900 dark:text-gray-100">Grade Distribution</CardTitle>
        </CardHeader>
      ...
      <Card className="bg-white dark:bg-slate-800">
        ...
        <CardContent className="space-y-4">
          {totalCredits && (() => {
            ...
            return (
              <div className="p-4 rounded-lg bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-700">
                ...
                <p className="text-sm font-medium text-blue-600 dark:text-blue-300 mt-1">
          ...
          {otherCurriculum.map((c, idx) => {
            ...
            return (
              <div key={idx}>
                <p className="font-semibold text-gray-900 dark:text-gray-100">{c.basketTitle}</p>
